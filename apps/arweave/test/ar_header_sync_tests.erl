...
test_syncs_headers() ->
	...
	{ok, FileInfo} = file:read_file_info(ar_storage:lookup_block_filename(B1#block.indep_hash)),
	ar_meta_db:put(disk_space, ?DISK_HEADERS_BUFFER_SIZE - FileInfo#file_info.size),
	ar_meta_db:put(used_space, FileInfo#file_info.size),
	...
	?assertMatch(#block{}, ar_storage:read_block(3, BI)).
